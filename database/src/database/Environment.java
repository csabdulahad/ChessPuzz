...
public class Environment {
    ...
    public static final String CHESSPGN_PATH = USER_HOME + PATH_SEPARATOR + "ChessPuzz";
    public static final String DB_PATH = CHESSPGN_PATH + PATH_SEPARATOR + "puzzle.db";
    ...
    public static void check() {
        ...
        File envFolder = new File(CHESSPGN_PATH);
